...
wp.blocks.registerBlockType('crystal-helper/single-product', 
  {    
    ...
    edit: function(props) {
      ...
      if (props.className === "wp-block-crystal-helper-single-product" && props.isSelected === true){ 
      ...
      async function openModal() {
        ...
        promise.then((result) => {
          if ($("[aria-label='Block: Classic']").length !== 0 && result === true) {
            CrystalCatalogHelper.Single.openModal("");
          }
        });
      }
